    ...
    <div className='parant'>
      {
        jobOpenings.map(function (elem, idx) {
          ...
          return (
            <Card key={idx} company={elem.companyName} logo={elem.brandLogo} location={elem.location} date={elem.datePosted} post={elem.post} pay={elem.pay} tag1={elem.tag1} tag2={elem.tag2} />
          )
        })
      }
    </div>
